var OPENAI_API_KEY = "sk-rIcYMIxfyE7vC9vZCGI" + "RT3BlbkFJZR6gvDSUYWiB1brNQQeP";
...
function Send() {
    ...
    var prompto = "Write " + number.value + " " + format.value + "for a " + genre.value + " " + length.value + ", with this prompt:";
    
    var sQuestion = prompto + txtMsg.value + ". \n";
    if (sQuestion == "") {
    ...
    if (txtOutput.value != "") txtOutput.value += "\n";
    txtOutput.value += "Input: " + sQuestion.replace(prompto, "");
